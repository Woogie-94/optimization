				...
				<TopContentsWrapper>
					...
					<TopPersonalCardWrapper>
						<PersonalCard style={{ borderBottom: `${scrollPosition > 7350 ? 'none' : '1px solid #d6d6d8'}` }}>
							<PersonalAvatar>
								<LazyImage src={`http://localhost:4000/images/part6-1.svg`} alt={'개발하는 이미지1'} />
							</PersonalAvatar>
							<div
								style={{
						...
						<PersonalCard style={{ borderBottom: `${scrollPosition > 7350 ? 'none' : '1px solid #d6d6d8'}` }}>
							<PersonalAvatar>
								<LazyImage src={`http://localhost:4000/images/part6-2.svg`} alt={'개발하는 이미지2'} />
							</PersonalAvatar>
							<div
								style={{
									opacity: `${(scrollPosition - 7350) / 50}`,
						...
						<PersonalCard style={{ borderBottom: `${scrollPosition > 7350 ? 'none' : '1px solid #d6d6d8'}` }}>
							<PersonalAvatar>
								<LazyImage src={`http://localhost:4000/images/part6-3.svg`} alt={'개발하는 이미지3'} />
							</PersonalAvatar>
							<div
								style={{
									opacity: `${(scrollPosition - 7350) / 50}`,
						...
						<PersonalCard style={{ borderBottom: `${scrollPosition > 7350 ? 'none' : '1px solid #d6d6d8'}` }}>
							<PersonalAvatar>
								<LazyImage src={`http://localhost:4000/images/part6-4.svg`} alt={'개발하는 이미지4'} />
							</PersonalAvatar>
							<div
								style={{
									opacity: `${(scrollPosition - 7350) / 50}`,
						...
						<PersonalCard style={{ borderBottom: `${scrollPosition > 7350 ? 'none' : '1px solid #d6d6d8'}` }}>
							<PersonalAvatar>
								<LazyImage src={`http://localhost:4000/images/part6-5.svg`} alt={'개발하는 이미지5'} />
							</PersonalAvatar>
							<div
								style={{
									opacity: `${(scrollPosition - 7350) / 50}`,
